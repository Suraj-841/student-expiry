...
export default function StudentCard({
  ...
  return (
    <div className={`relative ${isExpired ? 'bg-red-100 dark:bg-red-900' : 'bg-white dark:bg-gray-800'} shadow-xl rounded-2xl p-6 mb-6 transition hover:shadow-2xl border border-gray-200 dark:border-gray-700`}
      style={{ fontFamily: 'Inter, sans-serif', maxWidth: 480, margin: 'auto' }}>
